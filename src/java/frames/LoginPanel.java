...
public class LoginPanel extends javax.swing.JFrame {
    ...
    private void initComponents() {
     ...
     private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
         JMSContext context = Kupac.connectionFactory.createContext();

         Destination destination = Kupac.zahtevi;
         String username = jTextField1.getText();
         String password = jTextField2.getText();

         JMSConsumer consumer = context.createConsumer(Kupac.odgovori, Helpers.getId(username, password));
         ...
         try {
             ...
             zahtev.setIntProperty("tip", TipZahteva.LOGIN_KUPAC.ordinal());
         ...
         if (odgovor instanceof ObjectMessage) {
             try {
                 ...
                 if (objekat != null) {
                     ...
                     kupac.Kupac.homePanel = new HomePanel();
